...
if (!defined("_VIEW_HISTORY_DESC"))    define("_VIEW_HISTORY_DESC", "Consulter l'historique des événements relatifs à l'utilisation de la GED I-Courrier.");
if (!defined("_VIEW_FULL_HISTORY_DESC"))    define("_VIEW_FULL_HISTORY_DESC", "Consulter l'historique complet des événements relatifs à l'utilisation de la GED I-Courrier.");
...
if (!defined("_WELCOME")) define("_WELCOME", "Bienvenue sur I-Courrier !");
...
if (!defined("_YOUR_FIRST_CONNEXION")) define("_YOUR_FIRST_CONNEXION", "Bienvenue sur I-Courrier ! <br/>Ceci est votre première connexion");
...
if (!defined("_APPS_COMMENT")) define("_APPS_COMMENT", "Application I-Courrier");
...
if (!defined("_STANDARD_LOGIN")) define("_STANDARD_LOGIN", "Authentification I-Courrier");
...
if (!defined("_CONFIRM_ASK_RA_CODE_2"))    define("_CONFIRM_ASK_RA_CODE_2", "votre code de connexion distant a l'application I-Courrier est : ");
...
if (!defined("_CONFIRM_ASK_RA_CODE_6"))    define("_CONFIRM_ASK_RA_CODE_6", "Votre code de connexion I-Courrier");
